...
const LandingPage: React.FC<LandingPageProps> = ({ onEnter }) => {
  ...
  const sponsorLogos = [
    ...
    { name: 'Ministère du travail', url: 'https://encrypted-tbn0.gstatic.com/imagesq=tbn:ANd9GcRzNCD2kbQVXobhImQe5kDUs8WJz8ulim191Q&s' },
  ];
           ...
           <div className="w-full lg:w-1/2 space-y-8">
              ...
              <div>
                    ...
                    <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-slate-900 mb-6 leading-tight">
                      ...
                      Connecte  tout<br/> l'écosystème public.
              ...
              <div className="grid grid-cols-2 gap-y-10 gap-x-8 pt-8 border-t border-slate-100">
                  ...
                  <div className="group">
                      ...
                      <p className="text-sm text-slate-500 font-semibold pl-1">Open Data et souverain</p>
      ...
      <section id="team" className="px-6 md:px-12 py-32 bg-slate-50 w-full text-slate-900 border-t border-slate-200">
          <div className="max-w-7xl mx-auto">
                  ...
                  <p className="text-slate-500 max-w-2xl mx-auto font-normal">
                      Nous sommes trois passionnés de data et d’innovation, fiers de contribuer à l’avenir de notre région. Avec AUBE, nous voulons aider la Normandie à anticiper ses mutations, soutenir ses filières et rester un territoire d’opportunités pour tous.
                  </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                {[
                  ...
                  <div key={member.name} className="group bg-white p-6 rounded-3xl border border-slate-200 shadow-lg shadow-slate-200/50 hover:-translate-y-2 transition-all duration-300">
                    <div className="relative mb-6">
                      <div className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${member.accent} opacity-70 blur-xl group-hover:opacity-100 transition-opacity duration-500`}></div>
